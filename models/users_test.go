...
var (
	userDBTypes = map[string]string{`CreatedAt`: `timestamp with time zone`, `DeletedAt`: `timestamp with time zone`, `ID`: `integer`, `Name`: `text`, `UpdatedAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
